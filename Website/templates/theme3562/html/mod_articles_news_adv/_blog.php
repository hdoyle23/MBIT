...
<div class="item_content">
	<?php if ($params->get('published') || $params->get('createdby') || $params->get('show_category') || $params->get('show_hits')) : ?>
	<!-- info TOP -->
	<div class="item_info">
		<dl class="item_info_dl">
			...
			<?php if (class_exists('Komento') && Komento::loadApplication('com_content')) : ?>
			<dd>
				<div class="komento">
