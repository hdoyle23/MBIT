...
<div id="t3-mainbody" class="t3-mainbody">
	...
	<div class="container">
		<div class="row">
			...
			<!-- SIDEBAR RIGHT -->
			<div class="t3-sidebar t3-sidebar-right col-xs-12 col-sm-<?php echo $rside_width;?> <?php $this->_c('sidebar-2') ?>">
				<div class="t3-sidebar-content">
					<jdoc:include type="modules" name="<?php $this->_p('sidebar-2') ?>" style="themeHtml5" />
				</div>
			</div>
			<!-- //SIDEBAR RIGHT -->
		</div>
