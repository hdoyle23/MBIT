...
?>
<div class="mod_bootstraptabs mod_bootstraptabs_<?php echo $moduleclass_sfx; ?>">
	...
	<ul class="nav nav-tabs bootstraptabs bootstraptabs_<?php echo $moduleclass_sfx; ?>" id="bootstrap_tabs_nav_<?php echo $module->id; ?>">
